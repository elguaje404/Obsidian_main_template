```
administrador@ubusrvn8n:~$ cat /usr/share/vim/vim82/tutor/tutor.es.utf-8
==============================================================================
...
- ⚡ **No intentes aprender todos los comandos en un día.** Ve poco a poco, usa lo que necesitas y deja que la práctica te lo grabe en la memoria.
    
- 📝 **Practica siempre dentro de un archivo de prueba**, así no pierdes trabajo real mientras aprendes.
    
- 🎮 **Gamifica tu aprendizaje**: prueba [Vim Adventures](https://vim-adventures.com/), un juego para aprender Vim.
    
- 🌐 **Recursos útiles**:
    
    - `vimtutor` (lo tienes instalado con Vim).
        
    - Sitio interactivo: [openvim.com](https://www.openvim.com/)
        
- 🔍 Usa `:help` con frecuencia. Vim tiene una de las documentaciones más completas que existen.
